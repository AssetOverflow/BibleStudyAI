...
class TestRequestModels:
    ...
    def test_search_request_valid(self):
        ...
        request = SearchRequest(
            query="Microsoft AI", search_type=SearchType.VECTOR, limit=20
        )
...
class TestDatabaseModels:
    ...
    def test_chunk_embedding_validation(self):
        ...
        chunk = Chunk(
            document_id="doc-123", content="Test content", embedding=None, chunk_index=0
        )
...
class TestConfigurationModels:
    ...
    def test_ingestion_config(self):
        ...
        assert config.skip_graph_building is False
    ...
    def test_ingestion_config_validation(self):
        ...
        with pytest.raises(
            ...
            IngestionConfig(chunk_size=1000, chunk_overlap=1000)  # Same as chunk_size
...
class TestUtilityModels:
    ...
    def test_stream_delta(self):
        ...
        delta = StreamDelta(
            content="Hello", delta_type="text", metadata={"position": 0}
        )
