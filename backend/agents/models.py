...
class Chunk(BaseModel):
    """Bible chunk model with label-based filtering and rich metadata."""
    ...
    labels: Optional[List[int]] = None  # For label-based filtering
    chunk_index: int
    metadata: Dict[str, Any] = Field(default_factory=dict)
